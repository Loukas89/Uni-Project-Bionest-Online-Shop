...
// Fetch products and images for foods from the database
...
while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
    $row['ImagePath'] = base64_encode($row['ImagePath']);
    $products[] = $row;
}
...
<head>
    ...
    <title>Bio Shop - Organic Foods</title>
